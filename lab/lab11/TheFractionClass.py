...
class Fraction(object):
    ...
    def __sub__(self,f):
        """ Returns a Fraction that is the difference of self and f.
        If f1 is a Fraction and f2 is a Fraction or an int, then
        f3 = f1-f2 is a Fraction object that represents their difference.
    ...
    def __truediv__(self, f):
        """ Returns a Fraction that is the division of self by another Fraction 'other'.

        PreC: other is a Fraction object
        """
        if isinstance(f,Fraction):
            # f is a Fraction
            N = self.num*f.den
