...
class SimpleDate(object):
    ...
    def Tomorrow(self):
        ...
        if d<Last:
            # Same Month
            d+=1
        else: #the last day of the month, tmr will be the first day of next month
            # Different Month
            d=1
            if m<12:
                # If it is not December...
                m+=1 #carry 1 into month digit
            else: #the last day of December, tmr will be the first day of next year
                # It is December so tomorrow is New Years Day...
                m=1 #in Dec, carry 1 into year digit
                y+=1
