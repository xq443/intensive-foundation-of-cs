...
class Fraction:
    ...
    def __truediv__(self,f):
        ...
        """return a fraction that is division of self by f.  f= self/ f is a fraction object that represnets the division of self. f 
        -- assumng self is an instance of Fraction  and f is either a Fraction type or an int.
