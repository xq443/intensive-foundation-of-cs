...
#TODO: complete the following function definition to do as stated
def getCharCount(FName):
    """Returns an int n, where n is the total number of characters in file FName.

    PreC: FName is a string that names the file that is to be read.
    It should include the suffix, i.e., MyFile.txt.
    The file must be in the current working directory.
    """
    all_lines = fileToStringList(FName)

    n = 0 #keep track of the total number of characters in FName
