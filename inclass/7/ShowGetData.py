...
from GetData import fileToStringList, stringToWordList, getCharCount
...
n = getCharCount(NameOfFile)#TODO:complete the function's definition in GetTextData.py
print ('Num of chars = %7d' % n )
